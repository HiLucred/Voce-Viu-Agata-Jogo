...
export function NewsLetterModal() {
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content
        className="bg-white fixed z-40 top-20 left-0 flex flex-col gap-10 justify-center h-4/5 pt-12 rounded-md px-6 mx-2 md:w-2/5 md:left-[30%] lg:left-[30%] lg:h-3/5"
      >
        <form onSubmit={handleSubmit(handleNewsLetterFormData)}>
          <div>
            <h2 className="text-xl font-bold md:text-4xl ">Assine nossa NewsLetter</h2>
            <p className="text-sm md:text-lg mb-4">
              e fique antenado as novidades semanais sobre &quot;Você viu Ágata?&quot;
            </p>
          </div>
          ...
          <button disabled={isSubmitting} className="bg-red-500 py-3 text-white w-full mt-4">
            ASSINAR
          </button>
        </form>
