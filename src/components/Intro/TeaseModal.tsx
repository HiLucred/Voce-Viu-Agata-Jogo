...
export function TeaserModal() {
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="bg-black fixed z-50 top-20 left-0 flex justify-center items-center w-full h-3/5 pt-12 rounded-md md:w-4/5 md:h-4/5 md:left-[10%]">
        <iframe
