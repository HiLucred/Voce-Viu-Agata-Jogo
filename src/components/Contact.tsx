...
export function Contact() {
  return (
    <div id="contact" className="bg-detective-painting w-full py-12 bg-center bg-cover bg-no-repeat">
      <div className="w-3/5 max-w-xs m-auto flex flex-col items-center justify-center">
        ...
        <button type="button" className="w-[70%] hover:scale-150 transition-all">
        ...
        <div 
          ...
          className="bg-white w-12 p-2 flex items-center justify-center mt-10 border border-black cursor-pointer shadow-md">
