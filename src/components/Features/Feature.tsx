...
export function Feature({ title, description }: FeatureProps) {
  return (
    <div className="bg-crumpled-paper h-28 w-4/5 px-8  flex flex-col items-center justify-center hover:scale-110 transition-all shadow-xl relative max-w-2xl sm:py-28 cursor-default">
      <h2 className="text-md text-red-600 underline sm:text-3xl mb-4">
        {title.toUpperCase()}
      </h2>
